...
-- AI chats
vim.keymap.set('n', '<leader>ac', ':CodeCompanionChat<cr>', { desc = '[C]hat' })
vim.keymap.set('n', '<leader>aa', ':CodeCompanionActions<cr>', { desc = '[A]ctions' })
vim.keymap.set('n', '<leader>ai', ':CodeCompanion<cr>', { desc = '[I]nline Prompt' })
vim.keymap.set('v', '<leader>ac', ':CodeCompanionChat<cr>', { desc = '[C]hat' })
vim.keymap.set('v', '<leader>aa', ':CodeCompanionActions<cr>', { desc = '[A]ctions' })
vim.keymap.set('v', '<leader>ai', ':CodeCompanion<cr>', { desc = '[I]nline Prompt' })
